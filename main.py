...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.questions_list = [
            "Click Next To Start!!!",
            "What are your primary areas of interest for \
            studying at the university?",
            "Which subjects or fields do you find most \
                fascinating?",
            "Are you interested in pursuing a career in the\
                sciences, arts, business, or something else?",
            "Do you have a specific passion or hobby that \
                you would like to incorporate into your future studies?",
            "What kind of activities or topics do you enjoy \
                reading or learning about in your free time?",
            "How do you envision yourself contributing to \
                society through your chosen field of study?",
            "Do you prefer working with hands-on practical \
                tasks or theoretical concepts and analysis?",
            "What are your career aspirations or professional\
                  goals after completing your university education?",
            "Are there any specific industries or sectors you \
                are interested in working in after graduation?",
            "What personal strengths and skills do you believe\
                  will be valuable in your chosen field of study?",
            "How do you handle challenges and setbacks in your\
                 academic or personal life?",
            "Do you prefer a comprehensive and broad-based \
                course or a more specialized and focused one?",
            "Would you like to explore interdisciplinary \
                courses that combine multiple subjects?",
            "How important is it for you to have engaging \
                and interactive lectures and classes?",
            "Would you like your course to include practical\
        ...
        self.ui.queLabel.setText(
            QCoreApplication.translate("MainWindow",
                                       u""+self.questions_list[0], None))
        ...
        self.model.setQuery(
            "SELECT UniName,title,SubInstType FROM Entities ORDER BY UniName")
    ...
    def nextQuestion(self):
        ...
        if self.currQ > 0 and self.currQ < len(self.questions_list):
            ...
            self.ui.queLabel.setText(
                QCoreApplication.translate("MainWindow", u""+question, None))
    ...
    def resetQuestion(self):
        ...
        self.ui.queLabel.setText(
            QCoreApplication.translate(
                "MainWindow", u""+self.questions_list[0], None))
        self.ui.ansInput.setHidden(True)
    ...
    def update_filter(self):
        ...
        query = f"""
            ...
            FROM Entities
            WHERE UniName LIKE \
                '%{search_text}%' OR title LIKE '%{search_text}%'
        """
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": "Analyze \
                 the following dictionary item where the \
                 key is question and value is answer then \
                 recommend 5 good courses and reason \
                 why, output should be in a well \
                 structured html format that fills up the whole \
